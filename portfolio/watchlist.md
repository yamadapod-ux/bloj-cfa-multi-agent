...
*ล่าสุด: Prune Pass (2026-08-05, Mode 1 Step 0 — Round 3) + Scout Round 18 (2026-08-05) — ดู Scout History และ 🗄️ Archive ด้านล่าง*
...
|--------|---------|--------|-----------|------|-----------|-----------|-----|--------|--------|
| MSFT | Microsoft Corporation | Software / Cloud | 2026-05-09 | $415 | ~2.4% | ~14% CAGR | ~35% | AI Copilot + Azure hyperscaler + ลด 20% จาก GF Value $543; P/E ~22x = modestly undervalued per GuruFocus | **รอ Analysis — Target date 2026-08-06 (SLA fix 2026-07-30, เดิม stale 82+ วันไม่มี target date)** |
...
| CRDO | Credo Technology Group Holding Ltd. | Semiconductor / AI Networking Optics (AEC + Optical DSP) | 2026-07-06 | $205.00 (2026-08-01, 2 sources: Robinhood/CNBC aggregator range, day range $199.39-216.97) (Blended FV $185.86, MOS -9.3%) | FCF margin 34.32% (FCF Yield 0.90%, stale) | +205.68% FY2026 YoY | Conviction 6.3/10 (Emma 6/Quinn 6/Bear 7) -- ROE 22.9% | Analyzed 2026-07-06. Growth Gate FAIL (Conviction 6.3 < 6.5). Entry zone T1 $175-190 / T2 $150-165. Stop $130. PRUNE UPDATE 2026-08-02: ราคาเด้งกลับขึ้นมา $205.00 (จาก $177.45 Jul29) -- หลุดออกจาก entry zone T1 $175-190 อีกครั้งและห่างจาก re-analysis trigger zone $150-175 มากขึ้น (MOS กลับมาติดลบ -9.3% จาก +4.7%) -- ยกเลิก fast-track flag รอบก่อน, กลับสู่ HOLD/WAIT ปกติ | **HOLD/WAIT FOR PULLBACK -- Analyzed, conv 6.3 < 6.5 gate, ราคาหลุดออกจาก trigger zone แล้ว (Aug1: $205)** |
...
| DXCM | DexCom, Inc. | Medical Devices / Continuous Glucose Monitoring | 2026-07-29 | $83.45 (2026-08-01, +11.95% post-earnings pop จาก $74.85) | 4.8% (stale, pre-earnings) | +13% Q2 2026 (Rev $1.31B, beat est $1.29B) | ROE 34.50% / ROIC 31.73-33.98% (stale, pre-earnings) | Analyzed 2026-07-29, Conv 6.17<7.0 + MOS +0.4% both gates FAIL. Entry zone $58-65. PRUNE UPDATE 2026-08-02 -- Q2 earnings result (Jul30): BEAT ทุกตัวชี้วัด (EPS $0.70 non-GAAP vs $0.61 est +15%, Op margin 25.1% vs 19.2% ปีก่อน, gross margin 64.1% +400bps) -- ไม่มี crash แบบ 2024 pattern ที่กลัวไว้ ตรงข้ามหุ้นพุ่ง +11.95% แทน ยืนยัน thesis (CGM duopoly + margin expansion) แต่ราคายิ่งห่างจาก entry zone $58-65 มากขึ้น (MOS ยิ่งติดลบลึกกว่าเดิม ~-9.9% ที่ FV เดิม $75.14) -- ไม่มี resolution ทาง upside สำหรับ deploy, รอ pullback ต่อไป | **HOLD/WAIT FOR PULLBACK -- earnings beat resolved (no crash), MOS ติดลบกว้างขึ้น, รอ pullback สู่ $58-65 zone** |
| ICE | Intercontinental Exchange, Inc. | Financial Exchange / Market Data & Clearing | 2026-07-29 | $152.48 (2026-07-31, close) | ~4.4% (stale, pre-earnings) | +5% Q2 2026 (Net revenue $2.7B, adj EPS $1.90 beat $1.88 est) | ROE 13.85-19.36% (stale) | Wide moat exchange/data network -- FCF-positive + ROE ผ่าน gate. PRUNE UPDATE 2026-08-02 -- Q2 earnings result (Jul30): BEAT (adj EPS $1.90 vs $1.88 est), GAAP diluted EPS $1.69 (+14% YoY), net income $958M. ประกาศ M&A ใหญ่: acquire MarketAxess $5.7B (สร้าง fixed income platform ที่ครอบคลุมที่สุด) + เพิ่ม buyback authorization ถึง $4.0B (Jul 1). การซื้อกิจการนี้เป็น thesis-relevant development ใหญ่ (leverage/integration risk เพิ่ม แต่ franchise แข็งขึ้น) -- ต้องรวมเข้า analysis เต็มรูปแบบ | **NEW -- พร้อมส่ง Charlie -- SLA FIX: Target date เดิม 2026-08-03 blown 2 วัน, re-set เป็น 2026-08-06 (ข้อมูลครบพร้อมวิเคราะห์เต็ม, priority สูง)** |
...
| VRT | Vertiv Holdings Co | Industrials / AI Data Center Power & Cooling Infrastructure | 2026-08-05 | $256.00 (2026-08-03, 2 sources: stockanalysis.com/WebSearch aggregator + Google Finance context cross-check, +5.97% day) | FCF guide $2.4-2.6B FY26 (yield stale, needs refresh) | +26.23% Q2 2026 YoY (revenue $10.23B FY2025 +27.69%) | ROIC 23.32% (top-tier, 5yr avg 17% beats industrials peers) | Growth bucket clean pass — AI data center power/thermal management market leader (liquid cooling + power infrastructure สำหรับ hyperscaler/AI capex boom), ROIC 23.32% ยอดเยี่ยม, Rev growth 26%+ ผ่าน 20% threshold สบาย; หุ้นร่วง -14% กลางสัปดาห์ (Q2 mixed results) แต่บริษัทยก FY26 rev guide ขึ้นเป็น $13.8-14.2B (จาก $13.5-14B) = เด้งกลับได้; ⚠️ ราคายังใกล้ 52w high (+145% ใน 52 สัปดาห์, +49% YTD) ไม่มี MOS discount ชัดเจน — ต้อง valuation check เข้มก่อนตั้ง conviction; sector ใหม่ทั้งหมด (Data Center Infrastructure ต่างจาก software/semis ที่มีอยู่) | **NEW — รอ Analysis — Target date 2026-08-08 (Top Pick รอบนี้, priority สูง)** |
| ETN | Eaton Corporation plc | Industrials / Electrical Equipment & AI Power Management | 2026-08-05 | $387.00 (2026-08-05, WebSearch aggregator, -9.1% ใน 90 วัน) | FCF $874M Q2 2026 (+22% YoY, yield stale needs refresh) | +21% Q2 2026 YoY (14% organic + 7% M&A; 3yr avg +8.8%, forward guide +10%/yr) | ROIC 14.93% | Value/Growth hybrid — electrical equipment + data center power infrastructure (grid/backup power สำหรับ AI capex boom), ROIC 14.93% ผ่าน gate สบาย, FCF แข็งแกร่งต่อเนื่อง; ย่อ -9.1% ใน 90 วันที่ผ่านมา = entry point ที่ดีกว่า VRT; growth organic 14% ไม่ถึง 20% threshold เต็ม (ต้องรวม M&A ถึงจะผ่าน) — ใกล้เคียง pattern ADSK (Value/Growth Hybrid); sector overlap บางส่วนกับ VRT (ทั้งคู่ AI power infra) แต่ธุรกิจต่างกัน (Eaton = diversified electrical equipment, VRT = pure-play data center thermal/power) | **NEW — รอ Analysis — Target date 2026-08-08 (คู่กับ VRT, sector theme เดียวกัน)** |
