...
| **QCOM** | Value | 2026-09-05 | $111.59 / $106.01 | **$85–97** ($91) | $73 | $168.71 (9/4) | **−46%** (ต้องย่อลึกที่สุดในกลุ่ม) | Beta mean-revert ≤1.50 2Q ติด / BMW-VW LOI→signed contract ≥$2B/yr / Sept 2026 US-China summit truce ต่ออายุ 12mo+ / QCT Handset decline ชะลอเหลือ single-digit YoY 2Q / ราคา ≤$85–97 | Sept 2026 US-China summit + Q4 FY2026 earnings (~พ.ย. 2026) |

> **หมายเหตุ:** 7/8 (ADI/MELI/ZETA/CHYM/OSCR/FSLR/QCOM) ต้องย่อ −33%+ ถึงเข้า entry — realistic เฉพาะใน bear market. **GCT (−13%) + potentially ADI on China ruling** = ใกล้ที่สุด (FSLR −33-38% อยู่อันดับถัดไป ไม่ไกลเท่า GCT แต่ใกล้กว่าตัวอื่น). **QCOM (−46%) เป็น gap ใหญ่ที่สุดในกลุ่มทั้งหมด** — Blended FV ร่วงเร็วกว่าราคาเสียอีก (Apple modem loss confirmed + WACC spike) ทำให้ entry zone ต่ำกว่าตัวอื่นมาก ถ้าตลาด correction −15–20% (มา ~1 ครั้ง/4–6 ปี) → ZETA/CHYM/OSCR เข้า range พร้อมกัน (QCOM ยังต้องย่อลึกกว่านั้นอีก)
