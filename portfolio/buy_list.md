...
*Charlie + Max | Last updated: 2026-09-09 (price/gap refresh — Portfolio Review Mode 3. **GCT gap −13%→−7% (ใกล้ที่สุด)**; 7 อื่นๆ gap ห่างขึ้นเล็กน้อยหรือ flat. ไม่มีตัวไหน FV เกิน 90 วัน. ไม่มี de-list / graduate.) — 8 Active (QCOM added 2026-09-05, FSLR 2026-09-03)*
