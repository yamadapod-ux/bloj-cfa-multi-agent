...
- **A. Beaten-down ด้วยเหตุผลที่ถูกต้อง (บังคับ — แก้ threshold 2026-09-13, เดิม ≥30% แก้เป็น ≥20% หลัง Round 27-29 ให้ 0-2 candidate/รอบต่อเนื่องในตลาด near-ATH — CIO ตัดสิน "30% เยอะไป"):** ราคาปัจจุบัน **ลง ≥ 20% จาก 52-week high** (ยืนยันด้วย WebSearch ≥2 sources — ห้ามใช้ scout price จากแหล่งเดียว, ดู Price Verification block ด้านล่าง) **และ** Max ต้องระบุ **"beaten-down reason"** เป็นข้อความสั้นๆ จัดประเภทเป็น 1 ใน 2:
